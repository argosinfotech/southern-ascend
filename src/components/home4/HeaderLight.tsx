...
const capabilitiesItems = [
  ...
  { label: "RFID/FOD Solutions", href: "/rfid-fod" },
              ...
              <div className="absolute top-full left-0 mt-3 min-w-[220px] bg-white border border-[#E8DFD1] shadow-xl py-2 z-50 rounded-lg">
                {capabilitiesItems.map((item) => (
                  <a
                    ...
                    className="block px-5 py-2.5 text-sm font-headline font-semibold text-gray-700 hover:text-secondary hover:bg-[#F5F2EE] transition-colors"
                  >
                    {item.label}
                  </a>
                ))}
