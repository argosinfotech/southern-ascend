    ...
    <section id="about" className="py-16 px-6 md:px-12 bg-white">
      <div className="max-w-[1920px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <motion.div
          ...
          id="contact"
          className="lg:col-span-4 bg-white p-12 border-t-8 border-secondary shadow-lg"
        >
          <h3 className="font-headline font-bold text-xl uppercase mb-6 text-gray-900">
            Connect with Us
          </h3>
          ...
          <ul className="space-y-6 mb-12">
            <li className="flex items-center gap-4">
              ...
              <span className="text-sm font-label tracking-wide uppercase text-gray-700">
          ...
          <a
            ...
            className="block w-full bg-secondary text-white py-4 font-headline font-bold uppercase text-xs tracking-[0.2em] hover:brightness-110 transition-all text-center"
          >
