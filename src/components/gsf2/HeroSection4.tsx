...
const HeroSection = () => {
  return (
    <section className="relative min-h-[700px] flex items-center px-6 md:px-12 pt-32 pb-16 overflow-hidden bg-[#FAF8F5]">
      ...
      <div className="relative z-10 max-w-4xl">
        ...
        <motion.h1
          ...
          className="font-headline text-4xl md:text-[3.5rem] leading-[1.1] font-extrabold tracking-tighter mb-8 uppercase text-brand-blue"
        >
          Mission-Critical{" "}
