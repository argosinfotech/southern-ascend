          ...
          <div className="max-w-[1920px] mx-auto grid lg:grid-cols-[1fr_400px] gap-12 lg:gap-16 items-start">
            <div>
              ...
              >
                ...
                <div className="w-12 h-[3px] bg-secondary mb-6" />
                <p className="text-gray-600 leading-relaxed text-lg">
                  You work directly with a focused engineering team that knows your program, backed by the expanded sourcing, logistics, and operational support of the Stephen Gould network.
                </p>
              </motion.div>
